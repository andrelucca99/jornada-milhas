...
import { DadosBusca, EstadosBr } from '../../core/types/type';
...
export class FormBuscaService {
  ...
  obterDadosDeBusca(): DadosBusca {
    ...
    const dadosBusca: DadosBusca = {
      ...
      origemId: this.obterControle<EstadosBr>('origem').value.id,
      destinoId: this.obterControle<EstadosBr>('destino').value.id,
